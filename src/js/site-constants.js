...
const CAPTIONS = {
  default: {
    ...
    notifications: {
      ...
      technicalFault:
        'Oops (( looks, like some technical troubles occured. Please, reload the page.',
      collectionEmpty:
        'Looks like you have not add any movie to this collection, yet.',
  ...
  ukrainian: {
    ...
    notifications: {
      searchFault:
        'Нажаль, немає фільмів, відповідаючих вашому запиту. Будь ласка, спробуйте ще раз.',
      searchMinLength:
        'Будь ласка, введіть хоча б один символ для початку пошуку.',
      searchRestricted:
        'Будь ласка, не використовуйте будь-які спеціальні символи.',
      technicalFault:
        'От халепа (( схоже, сталась якась технічна проблема. Будь ласка, перезавантажте сторінку.',
      collectionEmpty:
        'Схоже, ви покищо не додали жодного фильму до цієї коллекції.',
      pageNotExist: 'Схоже, такої сторінки не існує',
      welcome: 'Welcome to Filmoteka - your movies library.',
      languageNotify: 'This site available in English.',
      videoUnavailable:
        'Вибачте, нажаль це відео недоступне українською мовою.',
    },
    movieDetails: {
      vote: 'Голос',
      votes: 'Голоси',
